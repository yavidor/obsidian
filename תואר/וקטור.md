...
aliases:
  ...
  - Vectors
  - vector
uid: 194318c3-7f1e-4519-ade7-3abf2b4d05ce
---
גודל וכיוון
# תיאור גיאומטרי
...
## חיבור וקטורים
נגיד ויש שני וקטורים, $\vec{a}$ ו$\vec{b}$, על מנת לחבר אותם מציירים את $\vec{b}$ איפה ש$\vec{a}$ נגמר, ואז הסכום $\vec{a}+\vec{b}$ הוא הצלע השלישית למשולש, מכוונת מתחילת $\vec{a}$ לסוף $\vec{b}$
```tikz
% Setup
\usetikzlibrary{arrows.meta, decorations.markings, bending}
\tikzset{>={Stealth[length=6pt, width=4pt, bend]}}
...
```
## אורך של וקטור הסכום
על מנת למצוא את $|\vec{a}+\vec{b}|$ נשתמש ב[[זהויות טריגונומטריות#משפט הקוסינוסים|משפט הקוסינוסים]], כלומר
$$
