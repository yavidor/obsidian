...
$$
	\int \frac{5x+11}{x^{2}+3x+6} \, dx  = \frac{5}{2}\int \frac{2x+3}{x^{2}+3x+6} \, dx + \frac{5}{7}\int \frac{1}{x^{2}+3x+6} \, dx 
$$

וכעת
$$
\begin{gather}
\frac{5}{2}\int \frac{2x+3}{x^{2}+3x+6} \, dx + \frac{5}{7}\int \frac{1}{x^{2}+3x+6} \, dx  \\
= \frac{5}{2}\ln \left| x^{2}+3x+6 \right| + \frac{5}{7}\int \frac{1}{x^{2}+3x+6}  \, dx  
\end{gather}
$$
# תרגיל 2
