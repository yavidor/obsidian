...
$$
	\begin{gather}
	\Delta_{i}= \left[ a_{i},a_{i-1} \right]  \\
	\omega_{i}=\underset{ x \in \left[ a_{i},a_{i-1} \right]  }{ \sup }f\left( x \right) - \underset{ x \in \left[ a_{i}-a_{i-1} \right]  }{ \inf } f\left( x \right) 
	\end{gather}
$$