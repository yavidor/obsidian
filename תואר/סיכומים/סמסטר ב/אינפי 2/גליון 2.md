...
$$
$f$ אינטגרבילית, לכן עבור $\frac{\varepsilon}{2}$ קיימת $\delta_{1}>0$ כך שלכל חלוקה $P=\left\{ a_{i} \right\}$ המקיימת $\lambda \left( P \right)<\delta_{1}$ ולכל בחירת $\left\{ t_{i} \right\}$ כך ש $t_{i}\in \left[ a_{i},a_{i-1} \right]$ מתקיים
$$
