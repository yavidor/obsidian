...
מכאן שלכל $P$
$$
	U\left( P,f \right) = \sum_{i}m_{i}\Delta_{i}= \underbrace{ m_{1}\Delta_{1} }_{ \geq 0 }+\underbrace{ m_{2}\Delta_{2} }_{ \geq 0 }+\ldots+\underbrace{ m_{k}\Delta_{k} }_{ > 0 } + \ldots + \underbrace{ m_{n}\Delta_{n} }_{ \geq 0 }> 0
$$
