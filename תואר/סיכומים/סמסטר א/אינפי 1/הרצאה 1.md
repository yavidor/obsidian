...
uni_subjects:
  - אינפי
uid: 0c57c984-b07d-496b-9d88-a766aebbe440
---
![[קבוצות מספרים]]
# ערך מוחלט
![[ערך מוחלט]]
...
$$
$.1$
$q>0$ מתרחש כיוון ש-$q$ הוא מכפלה שני מספרים חיוביים. של $r$ מהגדרה ושל $\sqrt{ n }-\lfloor \sqrt{ n } \rfloor>0$ כיוון שלפי ההנחה $\sqrt{ n }$ איננו שלם
...
$.2$
נותר להראות כי $q\sqrt{ n }\in \mathbb{N}$, ידוע כי $q\sqrt{ n }>0$ לכן די להראות ש $q\sqrt{ n }$ שלם
