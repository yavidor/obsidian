...
## כפל
$$
\left( a+ib \right) \cdot \left( c+id \right) := ac+\left( ad \right)i+\left( bc \right) i - bd = \left( ac-bd \right) +\left( ad+bc \right) i
$$
$$
...
$$
\begin{cases}
w_{0}=r^{\frac{1}{n}e^{ i \frac{\theta}{n} }} \\
w_{1}=r^{\frac{1}{n}e^{ i \frac{\theta+2\pi}{n} }} \\
\dots \\
w_{n-1}=r^{\frac{1}{n}e^{ i \frac{\theta \pi(n-1)}{n} }} \\
\end{cases}
$$
## הצגה טריגונומטרית
